//#region node_modules/.nitro/vite/services/ssr/assets/characters-CbiSUxJv.js
var CHARACTERS = [
	{
		id: "zeca",
		name: "Zeca Zero",
		emoji: "🎩",
		portrait: "/assets/char-zeca-X-nj3dnu.png",
		color: "hq-blue",
		difficulty: "novato",
	...
	},
	{
		...
		name: "Dona Zaíra",
		emoji: "👵",
		portrait: "/assets/char-zaira-DDTE4QPU.png",
		color: "hq-pink",
		difficulty: "amador",
		...
		lines: {
			...
			play: [
				"Hmm, essa aqui vai bem.",
				"Toma essa, coisa linda.",
				"Segura, moleque!"
			],
	...
	},
	{
		...
		name: "Seu Bigode",
		emoji: "🥸",
		portrait: "/assets/char-bigode-BVMUb5Ab.png",
		color: "hq-yellow",
		difficulty: "amador",
	...
	},
	{
		...
		name: "Zé Curinga",
		emoji: "🃏",
		portrait: "/assets/char-curinga-BsXVM8M_.png",
		color: "hq-red",
	...
	},
	{
		...
		name: "Robô Beta",
		emoji: "🤖",
		portrait: "/assets/char-robo-B1cqbuPW.png",
		color: "hq-blue",
		difficulty: "profissional",
	...
	},
	{
		...
		emoji: "🦸",
		portrait: "/assets/char-mula-Ck44g_V4.png",
		color: "hq-yellow",
		difficulty: "lendario",
...
function pickLine(c, key) {
	const arr = c.lines[key];
	return arr[Math.floor(Math.random() * arr.length)];
}
//#endregion
export { pickLine as n, CHARACTERS as t };
